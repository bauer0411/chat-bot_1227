...
# 환경 변수 설정
#os.environ["OPENAI_API_KEY"] = "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"
...
characters = {
    "스누피": ["https://i.namu.wiki/i/Oo7RdB1-KxiyqPPcIiRyUWoMeGTEgUL5kfWKk4AlJlzBJYIGp_etou2smFYNpaObNAdPVxHgDSWW6BOi0ImpnTmCsCWQj2bYlB14ynO8feykkg7W-AL_nCo_m-Wnn5P-zoECpIWIoq86dEi2FsqvOQ.webp"],
    "찰리 브라운": ["https://i.namu.wiki/i/RUd_Mie5LpgnsrgCoqrl2sHyffQU0IthSKYRo5n9-CZANP6FnRV2oOI5qT7KdBmHA-PkHFB0dHFHL_H7gn5FvdYfX5h-bxGphQL7A7QY_D8_ZmRIUf8u8-nqnmSIt3aNBRQXVQ7YfHyeSISiZ6ND6g.webp"]
}


# 사용자 아바타 이미지 URL
user_avatar_url = "https://blog.kakaocdn.net/dn/bqPYzR/btraWSj02cT/HnIasx6vc09IszobY6Fwe0/img.jpg"
...
def generate_conversation(language, character, user_input):
    ...
    [스누피]: [https://namu.wiki/w/%EC%8A%A4%EB%88%84%ED%94%BC].
    [차은우]: [https://namu.wiki/w/%EC%B0%B0%EB%A6%AC%20%EB%B8%8C%EB%9D%BC%EC%9A%B4], 말투는 반말로 해주세요.
